...
@section('content')
    <div class="flex">
        <div class="flex flex-col tbl">
            <div>
                <div class="text-center">Редагування ТП</div>
            </div>
            <form action="{{ route('admin.tps.update',['region' => $region, 'tp' => $tp]) }}" method="POST">
                @csrf
                @method('PATCH')
                <div class="flex flex-col tbl">
                    <div class="flex flex-row">
                        ...
                        <form action="{{ route('admin.tps.destroy', ['region' => $region, 'tp' => $tp]) }}" method="POST">
                            @csrf
                            @method('DELETE')
